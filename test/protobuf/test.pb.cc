...
constexpr User::User(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : name_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , age_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , sex_(0)
{}
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 33, -1, -1, sizeof(::fixbug::GetFriendListsResponse)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, 378, descriptor_table_protodef_test_2eproto, "test.proto", 
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.ResultCode)
  ...
  // uint32 errcode = 1;
  if (this->_internal_errcode() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_errcode());
  }
...
User::User(const User& from)
  ...
  if (!from._internal_age().empty()) {
    age_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_age(), 
      GetArenaForAllocation());
  }
  sex_ = from.sex_;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "fixbug.User.age"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
