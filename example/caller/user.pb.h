...
inline uint32_t LoginResponse::_internal_success() const {
  return success_;
}
inline uint32_t LoginResponse::success() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.success)
  return _internal_success();
}
inline void LoginResponse::_internal_set_success(uint32_t value) {
  
  success_ = value;
}
inline void LoginResponse::set_success(uint32_t value) {
...
inline uint32_t RegisterResponse::_internal_success() const {
  return success_;
}
inline uint32_t RegisterResponse::success() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.success)
  return _internal_success();
}
inline void RegisterResponse::_internal_set_success(uint32_t value) {
  
  success_ = value;
}
inline void RegisterResponse::set_success(uint32_t value) {
  _internal_set_success(value);
