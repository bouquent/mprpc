...
inline const std::string& RpcHeader::server_name() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.server_name)
  return _internal_server_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RpcHeader::set_server_name(ArgT0&& arg0, ArgT... args) {
 ...
 server_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.server_name)
}
inline std::string* RpcHeader::mutable_server_name() {
  std::string* _s = _internal_mutable_server_name();
  // @@protoc_insertion_point(field_mutable:mprpc.RpcHeader.server_name)
  return _s;
}
...
inline std::string* RpcHeader::release_server_name() {
  // @@protoc_insertion_point(field_release:mprpc.RpcHeader.server_name)
...
inline void RpcHeader::set_allocated_server_name(std::string* server_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mprpc.RpcHeader.server_name)
}
