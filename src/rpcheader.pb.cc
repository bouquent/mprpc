...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, server_name_),
...
const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\013server_name\030\001 \001(\t\022\023\n\013method_name\030\002 \001(\t\022"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  false, false, 106, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "mprpc.RpcHeader.server_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
